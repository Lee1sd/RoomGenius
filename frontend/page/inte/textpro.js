...
function Myproject() {
    ...
    const [galleryType, setGalleryType] = useState('shared'); // Track gallery type
    ...
    const handleGalleryTypeChange = (type) => {
        setGalleryType(type);
    };
    ...
    return (
        <div style={containerStyle}>
            <Interiormenu />
            <Furniture />
            <Create hideImageUpload={true} requireImage={false} mode="textpro" />
